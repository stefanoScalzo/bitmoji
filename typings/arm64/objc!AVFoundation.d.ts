...
declare class AVPlayerInterstitialEvent extends NSObject {
	...
	static interstitialEventWithPrimaryItemDateTemplateItemsRestrictionsResumptionOffset(primaryItem: AVPlayerItem, date: Date, templateItems: NSArray<AVPlayerItem> | AVPlayerItem[], restrictions: AVPlayerInterstitialEventRestrictions, resumptionOffset: CMTime): AVPlayerInterstitialEvent;

	static interstitialEventWithPrimaryItemTimeTemplateItemsRestrictionsResumptionOffset(primaryItem: AVPlayerItem, time: CMTime, templateItems: NSArray<AVPlayerItem> | AVPlayerItem[], restrictions: AVPlayerInterstitialEventRestrictions, resumptionOffset: CMTime): AVPlayerInterstitialEvent;

	static new(): AVPlayerInterstitialEvent; // inherited from NSObject

	static playerInterstitialEventWithPrimaryItemDateInterstitialTemplateItemsRestrictionsResumptionOffset(primaryItem: AVPlayerItem, date: Date, interstitialTemplateItems: NSArray<AVPlayerItem> | AVPlayerItem[], restrictions: AVPlayerInterstitialEventRestrictions, resumptionOffset: CMTime): AVPlayerInterstitialEvent;

	static playerInterstitialEventWithPrimaryItemTimeInterstitialTemplateItemsRestrictionsResumptionOffset(primaryItem: AVPlayerItem, time: CMTime, interstitialTemplateItems: NSArray<AVPlayerItem> | AVPlayerItem[], restrictions: AVPlayerInterstitialEventRestrictions, resumptionOffset: CMTime): AVPlayerInterstitialEvent;

	readonly date: Date;

	readonly interstitialTemplateItems: NSArray<AVPlayerItem>;
...
declare class AVPlayerInterstitialEventController extends AVPlayerInterstitialEventObserver {
	...
	static interstitialEventObserverWithPrimaryPlayer(primaryPlayer: AVPlayer): AVPlayerInterstitialEventController; // inherited from AVPlayerInterstitialEventObserver

	static new(): AVPlayerInterstitialEventController; // inherited from NSObject

	static playerInterstitialEventControllerWithPrimaryPlayer(primaryPlayer: AVPlayer): AVPlayerInterstitialEventController;

	static playerInterstitialEventObserverWithPrimaryPlayer(primaryPlayer: AVPlayer): AVPlayerInterstitialEventController; // inherited from AVPlayerInterstitialEventObserver

	events: NSArray<AVPlayerInterstitialEvent>;

	interstitialEvents: NSArray<AVPlayerInterstitialEvent>;

	cancelCurrentEventWithResumptionOffset(resumptionOffset: CMTime): void;
}

declare class AVPlayerInterstitialEventObserver extends NSObject {

	static alloc(): AVPlayerInterstitialEventObserver; // inherited from NSObject

	static interstitialEventObserverWithPrimaryPlayer(primaryPlayer: AVPlayer): AVPlayerInterstitialEventObserver;

	static new(): AVPlayerInterstitialEventObserver; // inherited from NSObject

	static playerInterstitialEventObserverWithPrimaryPlayer(primaryPlayer: AVPlayer): AVPlayerInterstitialEventObserver;

	readonly currentEvent: AVPlayerInterstitialEvent;

	readonly events: NSArray<AVPlayerInterstitialEvent>;

	readonly interstitialEvents: NSArray<AVPlayerInterstitialEvent>;
...
declare var AVPlayerInterstitialEventObserverCurrentEventDidChangeNotification: string;

declare var AVPlayerInterstitialEventObserverEventsDidChangeNotification: string;
