...
declare class UITitlebar extends NSObject {

	static alloc(): UITitlebar; // inherited from NSObject

	static new(): UITitlebar; // inherited from NSObject
...
declare const enum UITitlebarSeparatorStyle {
...
declare const enum UITitlebarTitleVisibility {
...
declare const enum UITitlebarToolbarStyle {
...
declare class UIViewController extends UIResponder implements NSCoding, NSExtensionRequestHandling, UIAppearanceContainer, UIContentContainer, UIFocusEnvironment, UIStateRestoring, UITraitEnvironment {
	...
	readonly childViewControllerForTouchBar: UIViewController;
