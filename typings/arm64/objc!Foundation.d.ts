...
declare class NSFileManager extends NSObject {
	...
	copyPathToPathHandler(src: string, dest: string, handler: any): boolean;
	...
	linkPathToPathHandler(src: string, dest: string, handler: any): boolean;
	...
	movePathToPathHandler(src: string, dest: string, handler: any): boolean;

	pathContentOfSymbolicLinkAtPath(path: string): string;

	removeFileAtPathHandler(path: string, handler: any): boolean;
